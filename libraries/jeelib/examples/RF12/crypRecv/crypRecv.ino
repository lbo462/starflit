...
void setup () {
   ...
   // rf12_initialize(1, RF12_868MHZ, 33);
    ...
    //rf12_initialize(1, RF12_915MHZ, 33); // frequence ne fonctionnant pas
...
void loop () {
    if (rf12_recvDone() && rf12_crc == 0) {
        ...
        rf12_encrypt(recvCount < 10 ? RF12_EEPROM_EKEY : 0); //  Encryptage impossible si 915MHz => ne vient pas de l'encryptage
    }
}
