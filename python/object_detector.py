...
class ObjectDetector:
    ...
    def calculate_box_center_and_normalize(self, xmin: float, xmax: float, ymin: float, ymax: float):
            """
            ...
            normalized = [int((center[0] - (x_frame / 2))), int((center[0] - (y_frame / 2)))]
            return normalized
        ...
        for i in range(int(num_boxes)):
            ...
            if self.object == labels[class_id]:
                if score > 0.8:
                    ...
                    return self.calculate_box_center_and_normalize(xmin, xmax, ymin, ymax)
                else:
                    return False
